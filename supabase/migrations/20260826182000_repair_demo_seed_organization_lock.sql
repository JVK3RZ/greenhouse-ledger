-- Keep demo seeding concurrency-safe without requiring UPDATE on organizations.
...
begin
  ...
  ) then raise exception 'Only the organization owner can load demo data'; end if;
  ...
  insert into public.locations (id, organization_id, name, location_type, notes) values
  ...
  insert into public.plant_catalog
    (id, organization_id, common_name, scientific_name, cultivar, sku, default_price, watering_days, feeding_days, care_notes) values
  ...
  insert into public.inventory_batches
    (id, organization_id, plant_catalog_id, location_id, batch_code, stage, quantity, unit_cost, unit_price, acquired_on, notes) values
  ...
  insert into public.inventory_transactions
    (organization_id, batch_id, transaction_type, quantity, note, performed_by) values
  ...
  insert into public.care_tasks
    (organization_id, batch_id, location_id, task_type, title, notes, due_at, assigned_to, recurrence_days, created_by) values
